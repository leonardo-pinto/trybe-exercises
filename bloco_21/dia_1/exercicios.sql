...
-- SELECT JOB_ID, SUM(salary) AS salary_per_job
-- FROM employees
-- GROUP BY JOB_ID;
...
-- 10. Escreva um query que exiba média salarial e o número de funcionários de todos os departamentos com mais de 
-- dez funcionários. Dica: agrupe pelo department_id.
-- SELECT department_ID, AVG(salary), COUNT(*) AS numero_func
-- FROM employees
...
-- 18: Escreva uma query que exiba as seguintes informações de cada funcionário: nome , sobrenome , tempo que trabalha 
-- na empresa (em dias).
