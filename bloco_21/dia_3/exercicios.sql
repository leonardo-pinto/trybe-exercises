...
-- crie um outro Trigger para INSERT que adiciona um novo registro na tabela movies_logs , informando o 
-- movie_id do filme que acaba de ser inserido na tabela movies , a executed_action como 'INSERT' e a log_date 
-- como a data atual.
-- USE BeeMovies;
-- DELIMITER $$
...
-- Crie um Trigger para UPDATE que, ao receber uma alteração na tabela movies , deve comparar o valor anterior de 
...
-- um novo registro na tabela movies_logs , contendo informações sobre o registro alterado ( movie_id , executed_action e 
-- log_date ).
...
-- FOR EACH ROW
-- BEGIN
-- 	INSERT INTO movies_logs (log_data, executed_action, movie_id)
